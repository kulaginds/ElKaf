...
<ul class="menu mb">
	<li>
		<form action="/administration/documents/authors/delete.php?id={$document.id}&author_id={$author.id}" method="POST">
			<input type="hidden" name="action" value="delete_author">
			<input type="submit" value="Да">
		</form>
	</li>
	<li><a href="/administration/documents/authors/index.php?id={$document.id}">Нет</a></li>
</ul>
{/if}