...
{/if}
<form action="/administration/groups/students/add.php?id={$group.id}" method="POST">
<input type="hidden" name="action" value="add_students">
<ul class="menu mb">
	<li><a href="/administration/groups/students/index.php?id={$group.id}">Cписок студентов</a></li>
</ul>
<table class="table">
	<tr>
