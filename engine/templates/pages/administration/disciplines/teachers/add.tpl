...
{/if}
<form action="/administration/disciplines/teachers/add.php?id={$discipline.id}" method="POST">
<input type="hidden" name="action" value="add_teachers">
<ul class="menu mb">
	<li><a href="/administration/disciplines/teachers/index.php?id={$discipline.id}">Cписок преподавателей</a></li>
</ul>
<table class="table">
	<tr>
