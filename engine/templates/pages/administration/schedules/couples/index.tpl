...
<form action="/administration/schedules/couples/index.php" class="mb">
...
<table class="table">
	...
	{foreach from=$weekdays key=weekday_index item=weekday}
		<th colspan="3">
			<a href="/administration/schedules/couples/day/index.php?id={$schedule.id}&week={$week}&weekday_index={$weekday_index}">{$weekday}</a>
		</th>
	{/foreach}
	</tr>
