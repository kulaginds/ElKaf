{if isset($ydiscipline)}
<h1>Добавление нового документа к дисциплине "{$ydiscipline.name}"</h1>
{else}
...
{/if}
<form enctype="multipart/form-data" action="/teaching/documents/add.php" method="POST">
	<fieldset>
		<table>
			<tr>
				<td>файл:</td>
			...
			<tr>
				...
				<td>
					...
					{if $discipline == $tdiscipline.id || $ydiscipline.id == $tdiscipline.id}
